...
const Footer = () => (
  <footer id='footer' className='mt-4'>
    This site is developed by <a href='https://adrian.frith.dev/'>Adrian Frith</a>.
    ...
    Population statistics were obtained from the Census 2001 Community Profile Databases, and geographical areas were calculated from the Census 2001 GIS DVD.
  </footer>
)
